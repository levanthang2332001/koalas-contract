...
export interface KoalasInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "DELEGATION_TYPEHASH"
      | "DOMAIN_TYPEHASH"
...
export interface Koalas extends BaseContract {
  connect(runner?: ContractRunner | null): Koalas;
  waitForDeployment(): Promise<this>;

  interface: KoalasInterface;
